...
"$PYTHON_BIN" "$BASE_DIR/scripts/generate_zitat.py"
...
cp "$BASE_DIR/pages/zitat/anzeige.html" "$STAGING_DIR/zitat/index.html"
...
cp "$BASE_DIR/static/css/display_pages/zitat.css" "$STAGING_DIR/static/css/display_pages/zitat.css"
...
cp "$BASE_DIR/resources/zitate/"*.png "$STAGING_DIR/resources/zitate/"
