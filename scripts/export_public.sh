...
cp "$BASE_DIR/pages/weisheit/anzeige.html" "$EXPORT_DIR/weisheit/index.html"
...
cp "$BASE_DIR/static/css/display_pages/weisheit.css" "$EXPORT_DIR/static/css/display_pages/weisheit.css"
...
cp "$BASE_DIR/resources/images/weisheit.png" "$EXPORT_DIR/resources/images/weisheit.png"
